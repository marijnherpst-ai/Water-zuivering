        ...
        <section className="relative">
          <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-5 text-sm text-dim">De levensduur verschilt per filter: het PPC- en CTO-filter gaan gemiddeld <strong className="text-ink">12 maanden</strong> mee, het RO-filter <strong className="text-ink">24 maanden</strong>. Het display op het apparaat laat je precies zien wanneer het tijd is om te vervangen.</p>
