export default function sitemap() {
  ...
  const routes = [
    ...
    { path: '/waterzuiveraar', priority: 0.6, changeFrequency: 'monthly' },
    { path: '/waterzuiveraar/rotterdam', priority: 0.6, changeFrequency: 'weekly' },
    { path: '/waterzuiveraar/utrecht', priority: 0.6, changeFrequency: 'weekly' },
    { path: '/waterzuiveraar/den-haag', priority: 0.6, changeFrequency: 'weekly' },
