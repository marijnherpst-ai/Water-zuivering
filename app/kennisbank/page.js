...
const ARTICLES = [
  ...
  {
    href: '/kennisbank/osmosewater-maken-thuis',
    image: '/assets/img/glas-water.webp',
    category: 'Uitleg',
    title: 'Osmosewater maken: kan dat gewoon thuis?',
    excerpt: 'Ja — met de juiste installatie is osmosewater maken net zo simpel als een kraan opendraaien.',
  },
  {
    href: '/kennisbank/wat-is-ro-water',
    image: '/assets/img/filters-closeup.png',
    category: 'Uitleg',
    title: 'Wat is RO-water en hoe werkt het?',
    excerpt: 'RO-water is water dat via omgekeerde osmose is gezuiverd. Hoe dat proces precies werkt.',
  },
  {
    href: '/kennisbank/omgekeerde-osmose-filter',
    image: '/assets/img/mineraalfilter.jpg',
    category: 'Uitleg',
    title: 'Omgekeerde osmose filter: hoe werkt het membraan?',
    excerpt: 'Het hart van elk osmosesysteem: een membraan van 0,0001 micron. Zo werkt het.',
  },
  {
    href: '/kennisbank/waterontharder-voor-en-nadelen',
    image: '/assets/img/kennisbank/waterontharder-vs-waterzuiveraar.png',
    category: 'Vergelijking',
    title: 'Waterontharder: voor- en nadelen op een rij',
    excerpt: 'Duidelijke voordelen tegen kalk, maar ook nadelen zoals zoutverbruik. Eerlijk op een rij.',
  },
  {
    href: '/kennisbank/waterontharder-zonder-afvoer',
    image: '/assets/img/systeem-liggend.png',
    category: 'Uitleg',
    title: 'Waterontharder zonder afvoer: hoe werkt dat?',
    excerpt: 'Een klassieke ontharder heeft altijd een afvoer nodig — wat de alternatieven wel en niet doen.',
  },
  {
    href: '/kennisbank/hoe-werkt-een-waterontharder',
    image: '/assets/img/kennisbank/kalkaanslag-in-huis.png',
    category: 'Uitleg',
    title: 'Hoe werkt een waterontharder?',
    excerpt: 'Ionenwisseling stap voor stap uitgelegd — en wat een ontharder juist niet doet.',
  },
  {
    href: '/kennisbank/drinkwaternormen-nederland',
    image: '/assets/img/kennisbank/is-kraanwater-veilig.png',
    category: 'Waterkwaliteit',
    title: 'Drinkwaternormen in Nederland: wat wordt er gecontroleerd?',
    excerpt: 'Nederlands kraanwater is streng gereguleerd. Wat valt er wel en niet onder de wet?',
  },
  {
    href: '/kennisbank/slechtste-kraanwater-nederland',
    image: '/assets/img/een-kraan.jpg',
    category: 'Waterkwaliteit',
    title: 'Is er "slechtste kraanwater" in Nederland? De feiten',
    excerpt: 'Verschillen tussen regio\'s zitten in smaak, niet in veiligheid. De feiten op een rij.',
  },
  {
    href: '/kennisbank/kraanwater-filteren',
    image: '/assets/img/twee-kranen.jpg',
    category: 'Koopgids',
    title: 'Kraanwater filteren: welke opties heb je?',
    excerpt: 'Van een simpele kan tot een compleet osmosesysteem — de opties op een rij.',
  },
  {
    href: '/kennisbank/waterontharder-aansluiten',
    image: '/assets/img/cabinet-install.png',
    category: 'Installatie',
