...
const AFZENDER = 'Water-zuivering <info@water-zuivering.nl>';
...
<div style="background:#F7F8FA; padding:32px 16px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
  <div style="max-width:480px; margin:0 auto; background:#FFFFFF; border:1px solid #E4E7EC; border-radius:20px; overflow:hidden;">
    ...
    <div style="margin:16px 32px 0; padding:18px 20px; border:1px solid #E4E7EC; border-radius:14px;">
    ...
    <div style="margin:16px 32px 24px;">
      <p style="margin:0 0 10px; font-size:12px; font-weight:700; letter-spacing:0.04em; text-transform:uppercase; color:#5B6472;">Wat klanten van ons zeggen</p>
      <div style="padding:14px 16px; background:#F7F8FA; border-radius:14px; margin-bottom:8px;">
        <p style="margin:0 0 6px; font-size:13px; color:#EDA71B;">&#9733;&#9733;&#9733;&#9733;&#9733;</p>
        <p style="margin:0; font-size:13px; line-height:1.55; color:#0B0D10; font-style:italic;">&ldquo;Super tevreden met de waterzuivering! Alles ging soepel en de installatie was zo geregeld.&rdquo;</p>
      </div>
      <div style="padding:14px 16px; background:#F7F8FA; border-radius:14px; margin-bottom:10px;">
        <p style="margin:0 0 6px; font-size:13px; color:#EDA71B;">&#9733;&#9733;&#9733;&#9733;&#9733;</p>
        <p style="margin:0; font-size:13px; line-height:1.55; color:#0B0D10; font-style:italic;">&ldquo;Top service gehad. Werd paar uur na aanvraag gebeld. Kreeg persoonlijk advies en dacht goed mee. Inmiddels staat het product en we merken zeker verschil.&rdquo;</p>
      </div>
      <a href="https://www.water-zuivering.nl/reviews" style="font-size:13px; font-weight:700; color:#0B0D10; text-decoration:none; border-bottom:2px solid #EDA71B;">Lees alle reviews &rarr;</a>
    </div>
