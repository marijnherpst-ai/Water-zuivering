...
export async function haalDashboardData(supabase) {
  ...
  const [campagnes, zoekwoorden, zoektermen, leadRijen, aanvragen, laatste, uren] = await Promise.all([
  ...
  return { vandaag, campagnes, zoekwoorden, zoektermen, leads, uren, aanvragen, bijgewerkt: laatste, demo: false };
}
